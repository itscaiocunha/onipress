...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row g-0">
            <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                    ...
                    <h1 class="mb-0 pb-0 display-4" id="title">Tipo de Ocorrência</h1>
    ...
    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select id, nome, status from OniPres_tipoOcorrencia where [status] = 'Ativo'">
    </asp:SqlDataSource>
