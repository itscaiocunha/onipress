            ...
            g = function a(b, c) {
              ...
              if (0 !== arguments.length) {
                (this._opts = e.extend(
                  ...
                  e.isObject(c) && void 0 !== c.pngStyle && (this._opts.pngStyle = c.pngStyle),
                ...
                (this._container = f),
                  this._container.appendChild(g.png),
                  this._opts.warnings && this._warnContainerAspectRatio(this._container),
                  this._opts.pngStyle && e.setStyles(g.png, this._opts.pngStyle),
                  (this.png = g.png),
                  (this.path = g.path),
                  (this.trail = g.trail),
                  (this.text = null);
